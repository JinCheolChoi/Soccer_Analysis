...
Year=2021
Countries=c("england")
Leagues=c("championship", "league-one", "premier-league") # "premier-league", "championship", "league-one", "league-two", "national-league"
...
#
#*********************************************
Leagues=c("league-one") # "premier-league", "championship", "league-one", "league-two", "national-league"
...
# winning rate
mean(Final_Combined_Over_Under_Score_Odds[, Result])

# avg odds
mean(Final_Combined_Over_Under_Score_Odds[, Chosen_Odds])
