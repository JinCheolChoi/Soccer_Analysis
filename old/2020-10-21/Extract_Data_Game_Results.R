...
for(Country in Countries){
  ...
  for(League in All_Leagues){
    for(Year in Years){
      ...
      if(Country=="spain" & League=="laliga" & Year%in%c(1989:2015)){
        url=paste0("https://www.betexplorer.com/soccer/", Country, "/primera-division-", Year, "-", Year+1, "/results/")
      }else if(Country=="china" & League=="super-league"){
        url=paste0("https://www.betexplorer.com/soccer/", Country, "/", League, "-", Year, "/results/")
      }else if(Country=="japan" & League=="j1-league" & Year%in%c(1998:2014)){
        url=paste0("https://www.betexplorer.com/soccer/", Country, "/j-league-", Year, "/results/")
      }else if(Country=="japan" & League=="j1-league" & Year%in%c(2015:2020)){
        url=paste0("https://www.betexplorer.com/soccer/", Country, "/j1-league-", Year, "/results/")
      }else if(Country=="japan" & League=="j2-league" & Year%in%c(2003:2014)){
        url=paste0("https://www.betexplorer.com/soccer/", Country, "/j-league-division-2-", Year, "/results/")
      }else if(Country=="japan" & League=="j2-league" & Year%in%c(2015:2020)){
        url=paste0("https://www.betexplorer.com/soccer/", Country, "/j2-league-", Year, "/results/")
