...
Leagues=c("premier-league", "championship", "league-one",
          "laliga",
          "serie-a",
          "eerste-divisie")
...
#
#*********************************************
Countries=c("england", "spain", "italy", "netherlands")
# england : "premier-league", "championship", "league-one", "league-two"
# spain : "laliga"
# italy : "serie-a"
# netherlands : "eerste-divisie"
Leagues=c("premier-league", "championship", "league-one", "league-two", "laliga", "serie-a", "eerste-divisie")
...
#****************************************************
Prob_Estimate="Implied" # Poisson, Exact, Negative_Binom, Implied
...
Simul_Result_Ind=1
source(paste0(CODE.dir.2, "SA_Functions.R"))
for(Prob_Estimate in c("Poisson", "Exact", "Negative_Binom", "Implied")){
...
Simul_Result[[2]]
Simul_Result[[3]]
Simul_Result[[4]][[1]][Date=="2020-09-19", Profit]
Simul_Result[[5]]
Simul_Result[[6]]
Simul_Result[[7]]
Simul_Result[[8]]
...
# if >0, profitable
for(i in 1:12){
  print(sum(Simul_Result[[i]][[1]][Result==1 & Date<="2022-09-20", Chosen_Odds]-1)-
          nrow(Simul_Result[[i]][[1]][Result==0 & Date<="2022-09-20", ]))
}
