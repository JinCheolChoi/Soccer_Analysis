...
#   return(Kelly/150)
# }
Kelly_Criterion=function(p, b, Coef=1){ # 10000, Exact, 1, Uni, "championship", "league-two", "laliga"
...
Over_Under_Score_Odds_Manipulation=function(Over_Under_Score_Odds){
  ...
  # Over_Under_Score_Odds[Home_Team=="Fe Club de Futbol", Home_Team:=""] # can't find this in result data
  # Over_Under_Score_Odds[Away_Team=="Fe Club de Futbol", Away_Team:=""]
