...
plot(win.data$kelly.criterion,win.data$joint.odds)
hist(lose.data$implied.joint.prob, breaks=100, col=rgb(1, 0.2, 0.2, 1))
hist(win.data$implied.joint.prob, breaks=200, add=T, col=rgb(0.2, 0.2, 1, 1))
...
hist(win.data$kelly.criterion, breaks=200, add=T, col=rgb(0.2, 0.2, 1, 1))
