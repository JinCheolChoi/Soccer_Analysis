...
analysis.data=analysis.data %>% arrange(Time, .by_group = T)
...
prob = analysis.data %>% dplyr::select(H.odd, D.odd, A.odd, H.win.prob, D.win.prob, A.win.prob)
