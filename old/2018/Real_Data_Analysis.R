...
# Parameter setting
###################
Directory="C:/Users/JinCheol Choi/Desktop/Soccer_Analysis/"
...
######################################
#load(paste0("/Users/JinCheol Choi/Desktop/My Folder/Soccer_Analysis/Empirical_Winning_Probability/", League, "/Empirical_winning_probability.Rdata"))
...
# World_Cup       : Years=c(2002, 2006, 2010, 2014, 2018)   #
#-------------------------------------------------------------#
Type="Kelly"                #------------------#
                              # "Kelly", "Fixed" #
                              #------------------#
Refine="TRUE"              # If TRUE, select the one with the max joint odds on the day
...
min.kelly=0.000                 # minimum kelly criterion
...
#-------------------------------- Parameter settings ---------------------------------#
#-------------------------------------------------------------------------------------#
#|                  | Type  | Refine | min.odd | max.odd | threshold.par | kelly.tunning.par |   min.kelly  |#
#| England_Premium  | Kelly | TRUE   |     5   | 1000000 |         1     |        0          |     0.000    |#
#| World_Cup        | Fixed | TRUE   |     5   | 1000000 |         1     |        0          |     0.005    |#
#-------------------------------------------------------------------------------------#
...
source(paste0(Directory, "Apply_Decision_to_Data.R"))
...
for(Year in Years){
  ...
  # import data
  source(paste0(Directory, "Real_Data.R"))
  
  # Decision_Making_Algorithm
  source(paste0(Directory, "Decision_Making_Algorithm.R"))
}
